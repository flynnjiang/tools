    ...
    ui(new Ui::MainWindow)
{
    ...
    programName = "通信扩展参数编辑器（" + buildDate.toString("yyyyMMdd") + "）";
...
void MainWindow::sync2GParamTo34G()
{
    ...
    ui->lineEdit3GHeartInt->setText(ui->lineEdit2GHeartInt->text());
    ui->lineEdit3GRedialInt->setText(ui->lineEdit2GRedialInt->text());
    ui->lineEdit3GRedialCnt->setText(ui->lineEdit2GRedialCnt->text());
    ...
    ui->lineEdit4GHeartInt->setText(ui->lineEdit2GHeartInt->text());
    ui->lineEdit4GRedialInt->setText(ui->lineEdit2GRedialInt->text());
    ui->lineEdit4GRedialCnt->setText(ui->lineEdit2GRedialCnt->text());
}
...
void MainWindow::set2GParamEnabled(bool enable)
{
    ...
    ui->lineEdit2GHeartInt->setEnabled(enable);
    ui->lineEdit2GRedialInt->setEnabled(enable);
    ui->lineEdit2GRedialCnt->setEnabled(enable);
}
...
void MainWindow::set3GParamEnabled(bool enable)
{
    ...
    ui->lineEdit3GHeartInt->setEnabled(enable);
    ui->lineEdit3GRedialInt->setEnabled(enable);
    ui->lineEdit3GRedialCnt->setEnabled(enable);
}
...
void MainWindow::set4GParamEnabled(bool enable)
{
    ...
    ui->lineEdit4GHeartInt->setEnabled(enable);
    ui->lineEdit4GRedialInt->setEnabled(enable);
    ui->lineEdit4GRedialCnt->setEnabled(enable);
}
...
void MainWindow::on_lineEdit2GHeartInt_textChanged(const QString &arg1)
{
    if (ui->checkBoxSameParam->isChecked()) {
        ui->lineEdit3GHeartInt->setText(arg1);
        ui->lineEdit4GHeartInt->setText(arg1);
    }
}

void MainWindow::on_lineEdit2GRedialInt_textChanged(const QString &arg1)
{
    if (ui->checkBoxSameParam->isChecked()) {
        ui->lineEdit3GRedialInt->setText(arg1);
        ui->lineEdit4GRedialInt->setText(arg1);
    }
}

void MainWindow::on_lineEdit2GRedialCnt_textChanged(const QString &arg1)
{
    if (ui->checkBoxSameParam->isChecked()) {
        ui->lineEdit3GRedialCnt->setText(arg1);
        ui->lineEdit4GRedialCnt->setText(arg1);
    }
}
